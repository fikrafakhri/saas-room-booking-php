            ...
            <div class="col-md-6 mb-4">
                <div class="card card-modern h-100">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between p-4">
                        ...
                        <div>
                            <a href="pages/manage_rooms.php" class="btn btn-success btn-modern w-100 mt-3 mb-2">
                                <i class="fa-solid fa-sliders me-2"></i> Konfigurasi Ruangan
                            </a>
                            <a href="pages/view_logs.php" class="btn btn-outline-danger btn-modern w-100">
